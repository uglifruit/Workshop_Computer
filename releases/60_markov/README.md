...
LED display shows the scale index in 6-bit binary across all six LEDs (X = lit, O = off). Read left-to-right then top-to-bottom: top row = bits 0/1, middle row = bits 2/3, bottom row = bits 4/5.
