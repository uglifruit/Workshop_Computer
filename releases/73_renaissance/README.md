# Renaissance — 6-voice harmonic oscillator for Workshop Computer
...
- Audio In 1 (FM) and Audio In 2 (PM) are silenced when nothing is patched — jack detection via normalisation probe
- Patch Audio Out back into Audio In 2 for feedback PM
- RAM usage: ~9.8KB (3.8% of 256KB)
